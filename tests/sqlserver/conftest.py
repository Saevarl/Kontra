...
def sqlserver_uri():
    ...
    return "mssql://sa:Kontra_Test123!@localhost:1433/kontra_test/dbo.users"


@pytest.fixture(scope="session")
def sqlserver_products_uri():
    """Return SQL Server connection URI for products table."""
    return "mssql://sa:Kontra_Test123!@localhost:1433/kontra_test/dbo.products"


@pytest.fixture(scope="session")
def sqlserver_orders_uri():
    """Return SQL Server connection URI for orders table."""
    return "mssql://sa:Kontra_Test123!@localhost:1433/kontra_test/dbo.orders"
